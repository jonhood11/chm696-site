...
**What the original figure plots.** It shows hand-drawn parallelogram illustrating determinant as signed area scaling.

**What this is trying to convey.** Geometric determinant construction from Jonathan's original notes.
...
:::{figure} figures/05-matrix-operations/redraw-determinant.png
:alt: Polished version of hand-drawn parallelogram illustrating determinant as signed area scaling
:width: 65%

The polished version preserves hand-drawn parallelogram illustrating determinant as signed area scaling. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::
...
The determinant, inverse, Pauli-matrix, and similarity problems below are
embedded from [Homework 2](../assignments/homework-02.md).

:::{include} ../assignments/homework-02.md
:start-after: ## Determinants, inverses, and matrix algebra
:end-before: ## Eigenvalues, eigenvectors, and diagonalization
:filename: false
:::
