...
10. Consider a model of a linear triatomic molecule in which the forces between the atoms are approximated by forces due to springs (see Figure). This problem is discussed on pp. 167-169 of Boas' book.
...
The original lecture refers to `linear_molecule_vib.png`. The file is preserved in the private Overleaf archive and will be redrawn or published after its reuse rights are verified.
:::
