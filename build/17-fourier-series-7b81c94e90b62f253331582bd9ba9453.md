...
**What the original figure plots.** It shows anatomy of the ear and cochlea involved in frequency analysis.

**What this is trying to convey.** The cochlea mechanically separates frequency components along its length.
...
:::{figure} figures/17-fourier-series/redraw-Fourier_ear.png
:alt: Polished version of anatomy of the ear and cochlea involved in frequency analysis
:width: 85%

The polished version preserves anatomy of the ear and cochlea involved in frequency analysis. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::

How sounds make their way from the source to the brain: <https://en.wikipedia.org/wiki/Cochlea>


**What the original figure plots.** It shows schematic of a cochlear implant signal-processing pathway.

**What this is trying to convey.** A cochlear implant converts sound into frequency-dependent stimulation channels.
...
:::{figure} figures/17-fourier-series/redraw-ear_implant.png
:alt: Polished version of schematic of a cochlear implant signal-processing pathway
:width: 85%

The polished version preserves schematic of a cochlear implant signal-processing pathway. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::
...
**What the original figure plots.** It shows hand-drawn interval expanding as L tends to infinity.

**What this is trying to convey.** Jonathan's sketch of the limit in which the discrete wave-number spacing tends to zero.

:::{figure} figures/17-fourier-series/imageLtoinfty.png
:alt: Hand-drawn interval expanding as L tends to infinity
:width: 65%

Jonathan's sketch of the limit in which the discrete wave-number spacing tends
to zero.
:::

**Polished version.**

:::{figure} figures/17-fourier-series/redraw-imageLtoinfty.png
:alt: Polished version of hand-drawn interval expanding as L tends to infinity
:width: 65%

The polished version preserves hand-drawn interval expanding as L tends to infinity. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::
...
**What the original figure plots.** It shows periodic piecewise-linear wave and a low-order Fourier approximation.

**What this is trying to convey.** Piecewise-linear periodic-wave example preserved from Jonathan's original notes and homework source.

:::{figure} figures/17-fourier-series/image.png
:alt: Periodic piecewise-linear wave and a low-order Fourier approximation
:width: 75%

Piecewise-linear periodic-wave example preserved from Jonathan's original
notes and homework source.
:::

**Polished version.**

:::{figure} figures/17-fourier-series/redraw-image.png
:alt: Polished version of periodic piecewise-linear wave and a low-order Fourier approximation
:width: 75%

The polished version preserves periodic piecewise-linear wave and a low-order Fourier approximation. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::
...
The full-wave rectifier problem is embedded from
[Homework 3](../assignments/homework-03.md).

:::{include} ../assignments/homework-03.md
:start-after: ## Fourier series
:end-before: ## Fourier transforms
:filename: false
:::

### Additional problem from Jonathan's original homework

:::{include} ../assignments/jonathan-homework-pool.md
:start-after: ## Triangle-wave Fourier series
:end-before: ---
:filename: false
:::
