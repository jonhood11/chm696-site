...
**What the original figure plots.** It shows factorization of a rectangular matrix into left singular vectors, singular values, and right singular vectors.

**What this is trying to convey.** Full singular value decomposition.
...
```{figure} figures/11-singular-value-decomposition/redraw-SVD1.png
:alt: Polished version of factorization of a rectangular matrix into left singular vectors, singular values, and right singular vectors
:width: 80%

The polished version preserves factorization of a rectangular matrix into left singular vectors, singular values, and right singular vectors. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows outer-product expansion of a matrix into singular-vector components.

**What this is trying to convey.** Each singular triplet contributes one rank-one matrix.
...
```{figure} figures/11-singular-value-decomposition/redraw-SVD2.png
:alt: Polished version of outer-product expansion of a matrix into singular-vector components
:width: 80%

The polished version preserves outer-product expansion of a matrix into singular-vector components. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows truncated singular value decomposition used for low-rank approximation.

**What this is trying to convey.** Keeping the leading $r$ singular triplets gives the best rank-$r$ approximation in both the spectral and Frobenius norms.
...
```{figure} figures/11-singular-value-decomposition/redraw-SVD3.png
:alt: Polished version of truncated singular value decomposition used for low-rank approximation
:width: 80%

The polished version preserves truncated singular value decomposition used for low-rank approximation. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows scatter plots with uncorrelated and strongly correlated variables.

**What this is trying to convey.** Uncorrelated and strongly correlated two-variable samples.
...
:::{figure} figures/11-singular-value-decomposition/redraw-example_covariance.png
:alt: Polished version of scatter plots with uncorrelated and strongly correlated variables
:width: 90%

The polished version preserves scatter plots with uncorrelated and strongly correlated variables. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::

**What the original figure plots.** It shows regression lines over uncorrelated and strongly correlated samples.

**What this is trying to convey.** Linear regression applied to the two covariance examples.
...
:::{figure} figures/11-singular-value-decomposition/redraw-example_regression.png
:alt: Polished version of regression lines over uncorrelated and strongly correlated samples
:width: 90%

The polished version preserves regression lines over uncorrelated and strongly correlated samples. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::

**What the original figure plots.** It shows covariance-matrix heatmaps for uncorrelated and strongly correlated data.

**What this is trying to convey.** Covariance matrices for the two synthetic data sets.
...
:::{figure} figures/11-singular-value-decomposition/redraw-example_heatmaps.png
:alt: Polished version of covariance-matrix heatmaps for uncorrelated and strongly correlated data
:width: 90%

The polished version preserves covariance-matrix heatmaps for uncorrelated and strongly correlated data. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::

**What the original figure plots.** It shows histograms of the four Iris measurements grouped by species.

**What this is trying to convey.** Feature distributions in the Iris data set.
...
:::{figure} figures/11-singular-value-decomposition/redraw-example_histograms.png
:alt: Polished version of histograms of the four Iris measurements grouped by species
:width: 90%

The polished version preserves histograms of the four Iris measurements grouped by species. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::

**What the original figure plots.** It shows individual and cumulative explained-variance ratios for Iris principal components.

**What this is trying to convey.** Individual and cumulative explained variance of the Iris principal components.
...
:::{figure} figures/11-singular-value-decomposition/redraw-example_explained_variance.png
:alt: Polished version of individual and cumulative explained-variance ratios for Iris principal components
:width: 85%

The polished version preserves individual and cumulative explained-variance ratios for Iris principal components. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::

**What the original figure plots.** It shows iris observations projected onto their first two principal components.

**What this is trying to convey.** Manual PCA projection of the Iris observations.
...
:::{figure} figures/11-singular-value-decomposition/redraw-example_pca_visualization.png
:alt: Polished version of iris observations projected onto their first two principal components
:width: 85%

The polished version preserves iris observations projected onto their first two principal components. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::

**What the original figure plots.** It shows scikit-learn PCA projection of Iris observations.

**What this is trying to convey.** The corresponding projection computed with scikit-learn.
...
:::{figure} figures/11-singular-value-decomposition/redraw-example_sklearn_pca.png
:alt: Polished version of scikit-learn PCA projection of Iris observations
:width: 85%

The polished version preserves scikit-learn PCA projection of Iris observations. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
:::
