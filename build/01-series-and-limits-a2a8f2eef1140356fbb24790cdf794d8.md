...
An infinite series is the sum of infinitely many terms: $$S = a_1 + a_2 + a_3 + \cdots = \sum_{n=1}^\infty a_n.$$ We define $S$ as the **limit** of partial sums: $$S_N=\sum_{n=1}^N a_n, \quad S=\lim_{N\to\infty} S_N$$
...
A power series about $x=0$: $$\sum_{n=0}^\infty a_n x^n = a_0  + a_1x + a_2x^2 + a_3 x^3 + \cdots$$ A power series about $x=a$: $$\sum_{n=0}^\infty a_n (x-a)^n = a_0  + a_1(x-a) + a_2(x-a)^2 + a_3 (x-a)^3 + \cdots$$
...
- Taylor series for f(x) about x=a: $$f(x)= f(a) + (x-a)f'(a) + \frac{1}{2!}(x-a)^2f''(a) + \cdots +  \frac{1}{n!}(x-a)^nf^{(n)}(a) + \cdots = \sum_{n=0}^\infty \frac{f^{(n)}(a)}{n!}(x-a)^n$$

- Maclaurin series is the Taylor series about the origin (i.e., a = 0): $$f(x)= f(0) + xf'(0) + \frac{1}{2!}x^2f''(0) + \cdots +  \frac{1}{n!}x^nf^{(n)}(0) + \cdots = \sum_{n=0}^\infty \frac{f^{(n)}(0)}{n!}x^n$$
