...
**What the original figure plots.** It shows model complexity illustrating underfitting, appropriate fit, and overfitting.

**What this is trying to convey.** Underfitting, an appropriate model, and overfitting as model complexity increases.
...
```{figure} figures/12-linear-regression/redraw-overfitting.png
:alt: Polished version of model complexity illustrating underfitting, appropriate fit, and overfitting
:width: 80%

The polished version preserves model complexity illustrating underfitting, appropriate fit, and overfitting. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows comparison of common residual error metrics.

**What this is trying to convey.** Different norms emphasize different features of the residual distribution.
...
```{figure} figures/12-linear-regression/redraw-error_metrics.png
:alt: Polished version of comparison of common residual error metrics
:width: 80%

The polished version preserves comparison of common residual error metrics. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows gradient descent trajectory for a nonlinear regression objective.

**What this is trying to convey.** Gradient-based fitting updates parameters in the direction of decreasing loss.
...
```{figure} figures/12-linear-regression/redraw-gradient_decent.png
:alt: Polished version of gradient descent trajectory for a nonlinear regression objective
:width: 80%

The polished version preserves gradient descent trajectory for a nonlinear regression objective. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows geometry of an overdetermined linear system.

**What this is trying to convey.** An overdetermined system generally has a residual even at its least-squares solution.
...
```{figure} figures/12-linear-regression/redraw-overdetermined.png
:alt: Polished version of geometry of an overdetermined linear system
:width: 80%

The polished version preserves geometry of an overdetermined linear system. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows geometry of L1 and L2 regularization constraints.

**What this is trying to convey.** The corners of an L1 constraint make sparse solutions more likely.
...
```{figure} figures/12-linear-regression/redraw-l1_norm_sparsity.png
:alt: Polished version of geometry of L1 and L2 regularization constraints
:width: 80%

The polished version preserves geometry of L1 and L2 regularization constraints. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows effect of L1 regularization on an overdetermined solution.

**What this is trying to convey.** L1 regularization can set some fitted coefficients exactly to zero.
...
```{figure} figures/12-linear-regression/redraw-overdetermined2.png
:alt: Polished version of effect of L1 regularization on an overdetermined solution
:width: 80%

The polished version preserves effect of L1 regularization on an overdetermined solution. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows geometry of an underdetermined linear system.

**What this is trying to convey.** An underdetermined consistent system has a family of exact solutions.
...
```{figure} figures/12-linear-regression/redraw-underdetermined.png
:alt: Polished version of geometry of an underdetermined linear system
:width: 80%

The polished version preserves geometry of an underdetermined linear system. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows regularized selection among underdetermined solutions.

**What this is trying to convey.** A norm penalty selects one solution from an underdetermined solution set.
...
```{figure} figures/12-linear-regression/redraw-underdetermined2.png
:alt: Polished version of regularized selection among underdetermined solutions
:width: 80%

The polished version preserves regularized selection among underdetermined solutions. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows noisy realizations of data generated from a parabola.

**What this is trying to convey.** Synthetic parabolic data with additive noise.
...
```{figure} figures/12-linear-regression/redraw-parabola.png
:alt: Polished version of noisy realizations of data generated from a parabola
:width: 80%

The polished version preserves noisy realizations of data generated from a parabola. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows polynomial design matrix with twenty basis functions.

**What this is trying to convey.** A high-degree polynomial basis creates a flexible but potentially unstable regression model.
...
```{figure} figures/12-linear-regression/redraw-20-polynomial.png
:alt: Polished version of polynomial design matrix with twenty basis functions
:width: 80%

The polished version preserves polynomial design matrix with twenty basis functions. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows high-degree polynomial fits obtained with a pseudoinverse.

**What this is trying to convey.** Unregularized high-degree least squares can vary strongly between noise realizations.
...
```{figure} figures/12-linear-regression/redraw-parabola_pinv.png
:alt: Polished version of high-degree polynomial fits obtained with a pseudoinverse
:width: 80%

The polished version preserves high-degree polynomial fits obtained with a pseudoinverse. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows comparison of fitted parabolas from several regression and regularization methods.

**What this is trying to convey.** Regression algorithms and regularizers produce different coefficient patterns and fitted curves.
...
```{figure} figures/12-linear-regression/redraw-parabola_different_regressions.png
:alt: Polished version of comparison of fitted parabolas from several regression and regularization methods
:width: 80%

The polished version preserves comparison of fitted parabolas from several regression and regularization methods. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows regression error versus fitting method and polynomial degree.

**What this is trying to convey.** Training and prediction errors reveal the effect of model complexity and regularization.
...
```{figure} figures/12-linear-regression/redraw-parabola_errors.png
:alt: Polished version of regression error versus fitting method and polynomial degree
:width: 80%

The polished version preserves regression error versus fitting method and polynomial degree. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
