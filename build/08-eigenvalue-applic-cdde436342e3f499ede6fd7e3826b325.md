...
**What the original figure plots.** It shows two equal masses coupled to one another and to fixed walls by three springs.

**What this is trying to convey.** A two-mass, three-spring model for normal modes.
...
```{figure} figures/08-eigenvalue-applications/redraw-coupled_oscillator_classical.png
:alt: Polished version of two equal masses coupled to one another and to fixed walls by three springs
:width: 55%

The polished version preserves two equal masses coupled to one another and to fixed walls by three springs. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows harmonic and Morse potentials for a diatomic vibration with force constant, reduced mass, and vibrational energy levels.

**What this is trying to convey.** One-dimensional vibrational analysis and the harmonic approximation.
...
```{figure} figures/08-eigenvalue-applications/redraw-vibrations1.png
:alt: Polished version of harmonic and Morse potentials for a diatomic vibration with force constant, reduced mass, and vibrational energy levels
:width: 90%

The polished version preserves harmonic and Morse potentials for a diatomic vibration with force constant, reduced mass, and vibrational energy levels. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows multidimensional Taylor expansion of a molecular potential and definition of the gradient and Hessian.

**What this is trying to convey.** The gradient vanishes at a stationary geometry, leaving the Hessian as the quadratic restoring-force matrix. The source slide is schematic; the one-dimensional second-order term requires the factor $1/2$ shown in the equation above.
...
```{figure} figures/08-eigenvalue-applications/redraw-vibrations2.png
:alt: Polished version of multidimensional Taylor expansion of a molecular potential and definition of the gradient and Hessian
:width: 90%

The polished version preserves multidimensional Taylor expansion of a molecular potential and definition of the gradient and Hessian. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows transformation from Cartesian displacements to mass-weighted coordinates in a molecular vibrational Hamiltonian.

**What this is trying to convey.** Mass weighting separates the kinetic-energy metric from the force-constant matrix.
...
```{figure} figures/08-eigenvalue-applications/redraw-vibrations3.png
:alt: Polished version of transformation from Cartesian displacements to mass-weighted coordinates in a molecular vibrational Hamiltonian
:width: 90%

The polished version preserves transformation from Cartesian displacements to mass-weighted coordinates in a molecular vibrational Hamiltonian. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows diagonalization of a mass-weighted Hessian into independent normal coordinates.

**What this is trying to convey.** Diagonalization rotates coupled mass-weighted coordinates into independent normal coordinates.
...
```{figure} figures/08-eigenvalue-applications/redraw-vibrations4.png
:alt: Polished version of diagonalization of a mass-weighted Hessian into independent normal coordinates
:width: 90%

The polished version preserves diagonalization of a mass-weighted Hessian into independent normal coordinates. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```

**What the original figure plots.** It shows independent harmonic-oscillator equations and the count of molecular vibrational modes.

**What this is trying to convey.** A nonlinear molecule has $3N-6$ vibrational modes, while a linear molecule has $3N-5$; the remaining coordinates correspond to overall translation and rotation.
...
```{figure} figures/08-eigenvalue-applications/redraw-vibrations5.png
:alt: Polished version of independent harmonic-oscillator equations and the count of molecular vibrational modes
:width: 90%

The polished version preserves independent harmonic-oscillator equations and the count of molecular vibrational modes. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows benzene p orbitals with Hückel parameters alpha and beta.

**What this is trying to convey.** The Hückel model retains one $p_z$ orbital per carbon, with site energy $\alpha$ and nearest-neighbor coupling $\beta$.
...
```{figure} figures/08-eigenvalue-applications/redraw-huckel1.png
:alt: Polished version of benzene p orbitals with Hückel parameters alpha and beta
:width: 85%

The polished version preserves benzene p orbitals with Hückel parameters alpha and beta. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
...
**What the original figure plots.** It shows hückel molecular-orbital energy levels and orbital shapes for benzene.

**What this is trying to convey.** Hückel molecular orbitals and energy levels for benzene. With the usual convention $\beta<0$, $\alpha+2\beta$ is the lowest level.
...
```{figure} figures/08-eigenvalue-applications/redraw-huckel2.png
:alt: Polished version of hückel molecular-orbital energy levels and orbital shapes for benzene
:width: 80%

The polished version preserves hückel molecular-orbital energy levels and orbital shapes for benzene. The variables, geometry, and comparison are unchanged; the crop, contrast, scale, and line clarity have been standardized for the web.
```
