...
7.  **Oscillatory motion** The equation of motion for a harmonic oscillator in classical mechanics is derived from $F = ma$ and is given by: $$\frac{d^2y(t)}{dt^2} = -\omega ^2 y(t)$$
